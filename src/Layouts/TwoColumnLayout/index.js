              ...
              {(navData || []).map((item, key) => (
                <React.Fragment key={key}>
                  {item.icon &&
                    (item.subItems ? (
                      <li>
                        <Link onClick={item.click} to='#' subitems={item.id} className='nav-icon' data-bs-toggle='collapse'>
                        ...
                        {item.subItems &&
                          (item.subItems || []).map((subItem, key) => (
                            <React.Fragment key={key}>
                              {!subItem.isChildItem ? (
                                <li className='nav-item'>
                                  <Link to={subItem.link ? subItem.link : '/#'} className='nav-link nav-custom-link'>
                                ...
                                <li className='nav-item'>
                                  <Link onClick={subItem.click} className='nav-link nav-custom-link' to='/#' data-bs-toggle='collapse'>
                                    {subItem.icon !== undefined && <i className={subItem.icon}></i>}
                                    {props.t(subItem.label)}
                                  </Link>
                                          ...
                                          <React.Fragment key={key}>
                                            {!childItem.isChildItem ? (
                                              <li className='nav-item' key={key}>
                                                <Link to={childItem.link ? childItem.link : '/#'} className='nav-link nav-custom-link'>
