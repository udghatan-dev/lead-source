...
// actions
import { loginUser, getPanelSettings as onGetPanelSettings, resetLogin } from '../../store/actions';
...
const AuthContainer = (props) => {
  ...
  return !loading ? (
    <React.Fragment>
      {theme === 'galaxy' && (
        <ThemeOne title='SignIn' authVariables={authVariables}>
          <>
            {isExpired && (
                ...
                <div className='p-2 mt-4'>
                  ...
                  >
                    ...
                    <div className='mb-3'>
                      ...
                      {ReCAPTCHA_SITE_KEY() !== '' &&
                        (captchaError ? <label className='text-danger fw-100 fs-12'>{'Invalid Captcha'}</label> : null)}
                    </div>
                  ...
                  <div className='mt-3 text-center fs-12'>
                    <p className='mb-0'>
                      {'By signing in to this app you are agree to '}{' '}
      ...
      {theme === 'vintage' && (
        <ThemeTwo title='SignIn' authVariables={authVariables}>
          <>
            {isExpired && (
              <div className='text-center mt-2'>
                <p className='text-danger'>{props.t('Your Session Expired')} !</p>
      ...
      {theme === 'default' && (
        <DefaultScreen title='SignIn' authVariables={authVariables}>
          <>
            {isExpired && (
              <div className='text-center mt-2'>
                <p className='text-danger'>{props.t('Your Session Expired')} !</p>
...
export default withRouter(withTranslation()(AuthContainer));
