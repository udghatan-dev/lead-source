...
import { MyToastContainer, ToastMe } from "./ToastInit";
...
const RightSidebar = (props) => {
  ...
  function saveMenuLayoutSettings() {
    var adminJson = {
    ...
    let menuHash = encrypt(JSON.stringify(adminJson));
    localStorage.setItem("_mu", menuHash);
    props.callback("menuLayout", adminJson);
    ToastMe("success", "top-right", "Settings Saved Successfully", 300);
  }
